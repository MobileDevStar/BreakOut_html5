...
playGame.prototype = {
    preload:function(){
        ...
        game.load.image("sky", "assets/sprites/background.png");
        ...
        game.load.image("title", "assets/sprites/title1.png");
  	...
  	create: function(){
       ...
       // ground.body.sprite.pivot.y = 40;
        ...
        var leftBut = game.add.sprite(40, 920, "left");
        leftBut.anchor.set(0.5);
        leftBut.inputEnable = true;
        leftBut.events.onInputDown.add(this.onclicks, this);
       // leftBut.game.input.onDown.add(this.onclicks, this);
     //  leftBut.events.onInputDown.add(click, this);

        this.rightBut = game.add.image(504, 920, "right");
       // game.input.onDown.add(this.onclicks, this);
       game.input.mouse.capture = true;
    },
    onclicks: function(leftBut) {
        //alert("adf");
        console.log("asdfa");
    },
    dropCrate: function(){
